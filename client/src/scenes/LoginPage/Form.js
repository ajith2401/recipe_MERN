...
const registerSchema = yup.object().shape({
    ...
    emailOrPhoneNumber: yup.string().email("Invalid email").required("Email is required"),
    password: yup.string().required("Password is required"),
  });
  

const loginSchema = yup.object().shape({
  emailOrPhoneNumber: yup.string().email("invalid email").required("required"),
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            <TextField
              ...
              error={Boolean(touched.emailOrPhoneNumber) && Boolean(errors.emailOrPhoneNumber)}
              helperText={touched.emailOrPhoneNumber && errors.emailOrPhoneNumber}
